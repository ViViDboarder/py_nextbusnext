...
class NextBusClient():
    ...
    def __init__(self, output_format, agency=None, use_compression=True):
        ...
        if not isinstance(agency, str):
            raise TypeError('"agency" must be a string.')
    ...
    def get_messages(self, route_tags, agency=self.agency):
    ...
    def get_route_list(self, agency=self.agency):
    ...
    def get_route_config(self, route_tag=None, agency=self.agency):
    ...
    def get_predictions(self, stop_id, route_tag=None, agency=self.agency):
    ...
    def get_predictions_for_multi_stops(self, stops, agency=self.agency):
    ...
    def get_schedule(self, route_tag, agency=self.agency):
    ...
    def get_vehicle_locations(self, route_tag, timestamp, agency=self.agency):
